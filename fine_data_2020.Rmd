...
# Reformat names to make them easier to join as not all names are formatted the
# same in different datasets.
...
# Consolidated the fines to sum the total amount of fines every player has 
# for further statistsics.
